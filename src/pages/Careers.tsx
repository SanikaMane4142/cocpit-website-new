        ...
        <div className="w-[448px] inline-flex flex-col justify-start items-start gap-6">
          ...
          <div className="w-full flex flex-col justify-start items-start gap-4">
            ...
            <div className="w-full flex flex-col justify-start items-start gap-2">
              ...
              <div className="w-full h-12 px-3 py-3 rounded-xl border border-dashed border-gray-500 flex justify-center items-center cursor-pointer hover:border-indigo-500 hover:bg-white/5 transition-colors">
                <div className="text-gray-500 text-sm font-normal">Select PDF/DOC</div>
              </div>
            </div>
          ...
          {/* Submit Button */}
          <button className="w-full h-12 px-3 py-3 bg-[#818cf8] hover:bg-indigo-400 transition-colors rounded-xl flex justify-center items-center">
            <span className="text-white text-base font-normal leading-5">Submit Application</span>
          </button>
